...
3. Свако поље: 7–9 граматички беспрекорних реченица, богато стручном терминологијом. Свако поље мора директно референцирати конкретне податке газдинства (назив носиоца, опрему, биљне културе, производе) — без генеричких реченица које могу бити копиране из другог пословног плана.
...
4. Свако поље: 4–7 граматички беспрекорних реченица које директно референцирају дате податке.
...
3. Формалан, стручан, конкретан регистар — без клишеа и генеричких реченица.
4. Поља opisDelatnosti: тачно 4–5 реченица (кратко, концизно). Сва остала поља: минимум 10–13 реченица, детаљних и конкретних.
5. Провери граматику — падежи именица морају бити тачни.
...
Врати САМО валидни JSON објекат са тачно овим кључевима (без markdown, без икаквог текста изван JSON-а):
{
  ...
  "trzisteProdajeTekst": "Детаљна анализа тржишта продаје — идентификовани постојећи и потенцијални купци по уговору, сегменти тржишта, начин пласмана производа, ценовна политика, конкурентска позиција, географско тржиште, могућности извоза. Минимум 11 реченица.",
  "trzisteSnabdevanjaTekst": "Детаљан опис тржишта снабдевања — репроматеријали, резервни делови, сервисне услуге за систем наводњавања, добављачи опреме и материјала, услови набавке, доступност резервних делова, процена ризика снабдевања. Минимум 11 реченица.",
  "opisPoslovneIdeje": "Свеобухватан опис пословне идеје и пројекта — предмет уlagања, конкретни циљеви инвестирања, очекивани ефекти на производне резултате, повећање приноса, уштеда воде, смањење трошкова рада, место и услови пласмана произведених производа. Минимум 11 реченица.",
  "zakljucak": "Исцрпна закључна оцена о оправданости пројекта — техничко-технолошка оправданост, економска исплативост, тржишна оправданост, доприност одрживом развоју пољопривреде, очекивани ефекти реализације инвестиције на приходе и пословне резултате, препорука за одобравање суфинансирања. Минимум 11 реченица."
}`;
}
