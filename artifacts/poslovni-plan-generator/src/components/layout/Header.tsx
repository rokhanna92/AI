    ...
    >
      <div className="max-w-7xl mx-auto px-6 h-14 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <span className="font-black text-base" style={{ ...TYPO.uiBold, color: tc.textPrimary }}>
              AGRO
            </span>
            <span className="font-black text-base" style={{ ...TYPO.uiBold, color: tc.heroTitle3 }}>
              PLAN
            </span>
            <span className="ml-2 align-middle" style={{ ...TYPO.labelXxs, color: tc.logoVersionText }}>
              v3.2
            </span>
          </div>
        </div>
