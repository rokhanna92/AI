...
export function SectionHeader({ icon: Icon, title, table, tc }: SectionHeaderProps) {
  return (
    <div
      className="flex items-start gap-3 mb-6 pb-4"
    ...
    >
      ...
      <div>
        {table && (
          <div
            className="inline-block mb-1 px-2 py-0.5 rounded text-[9px] font-bold tracking-[0.2em] uppercase"
            style={{
        ...
        <h3 className="font-bold text-sm tracking-wide" style={{ color: tc.sectionTitleColor }}>
          {title}
        </h3>
      </div>
    </div>
